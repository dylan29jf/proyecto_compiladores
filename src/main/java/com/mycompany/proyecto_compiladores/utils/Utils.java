 ...
 */
package com.mycompany.proyecto_compiladores.utils;
...
public class Utils {
    ...
    public int[] dividirFecha(String fecha) {
        int[] fechaDividida = new int[3];
            
        try {
            //transforma la cadena en un tipo date
            Date miFecha = new SimpleDateFormat("dd/MM/yyyy").parse(fecha);
            ...
            // año
            fechaDividida[0] = calendario.get(Calendar.YEAR % 100);

            //mes
            fechaDividida[1] = calendario.get(Calendar.MONTH <= 9 ? Integer.parseInt("0" + Calendar.MONTH) : Calendar.MONTH);
            //dia
            fechaDividida[2] = calendario.get(Calendar.DAY_OF_MONTH <= 9 ? Integer.parseInt("0" + Calendar.DAY_OF_MONTH) : Calendar.DAY_OF_MONTH);
    ...
    private static String obtenerClaveEntidadFederativa(String entidadFederativa) {
